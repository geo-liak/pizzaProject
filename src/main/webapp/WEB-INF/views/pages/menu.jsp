    ...
    <section id="Menu" class="container mt-2">
      ...
      <div class="row mx-2 align-items-center d-flex justify-content-center ">
          ...
          <c:forEach items="${products}" var="result">             
              <div class="card p-2 m-2 col-3" style="height: 420px; ">
                  <img class="card-img-top" style="height: 135px; " src="${contextPath}/resources/images/${result.imagePath}" alt="${result.name}">
                  <div class="card-body">
                      <div class="container" style="height: 130px;">
                      <h5 class="card-title">${result.name}, ${result.price}&euro; </h5>
